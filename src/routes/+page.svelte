...
<div class="py-8 px-10 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    ...
    <div class="">
        <div class="max-w-screen-md">
            ...
            <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">You're the architect of your own universe, mapping out every detail with passion. Now, meet us – your creative accomplices. We're here to fill the canvas of your world, adding characters, stories, and quests that bring your creation to life. You build the world; we'll sprinkle in the uhm.. sprinkles.</p>
